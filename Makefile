#---------------------------------------------------------------------------------
# DAGGERFALL UNITY -- Switch homebrew loader
# (forked from the PvZ Fusion 3.8.1 port; Unity 2022.3.62f3 / IL2CPP, arm64)
...
# dfu_imports_extra.c is picked up without editing this list. nx_patch_dfu.h
