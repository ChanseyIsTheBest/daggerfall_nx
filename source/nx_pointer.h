...
/* Tell the pointer the render space changed (Switch docking swaps 1280x720 <->
 * 1920x1080). Cheap no-op when the size is unchanged, so it is fine to call
 * every frame. The cursor keeps its relative position across the change. */
